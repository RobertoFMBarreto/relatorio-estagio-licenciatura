...
Para obter uma visão geral do projeto e uma previsão de finalização foi realizada uma planificação expectável de tarefas. Encontra-se no documento de anexos, no anexo 1, uma versão em maiores dimensões da Figura~\ref*{fig:1}.
